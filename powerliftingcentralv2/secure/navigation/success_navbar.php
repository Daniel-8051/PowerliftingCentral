...
function login_logout_button($choice){
    if(strcmp($choice, 'blank') === 0 ){
        ...
        $button = "<a href='../login.php' class='nav-link'>LOG IN</a>";
    } elseif(strcmp($choice, 'logout') === 0){
        $button = "<a href='../logout.php' class='nav-link'>LOGOUT</a>";
    } 
...
<!-- Navbar -->
    <nav id='mainNavbar' class='navbar navbar-dark navbar-expand-md fixed-top'>
        <div class='container-fluid'>
            <a href='#' class='navbar-brand mybrand display-1'>POWERLIFTING CENTRAL</a>
            <!-- Burger button -->
